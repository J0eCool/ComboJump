...
suite "AreaInfo":
  let testArea = AreaInfo(
    name: "TestArea",
    keyStages: @[
      StageDesc(stage: 1, level: 1, rooms: 4, enemiesPerRoom: 6,
        spawns: @[(goblin, 1.0)]),
      StageDesc(stage: 3, level: 5, rooms: 6, enemiesPerRoom: 12,
        spawns: @[(goblin, 2.0), (ogre, 1.0)]),
      StageDesc(stage: 5, level: 3, rooms: 4, enemiesPerRoom: 24,
        spawns: @[(goblin, 2.0)]),
    ],
  )
